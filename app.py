...
st.set_page_config(page_title="Hedge Fund Ricardo v61.0 (Heavy)", layout="wide")
...
def obter_dados(ticker):
    try:
        t = yf.Ticker(ticker); hist = t.history(period="2y") # Período maior para médias longas
...
with tabs[0]:
    ...
    if st.button("Analisar"):
        ...
        if r:
            ...
            # --- BLOCO 3: SETUP TÉCNICO (COMPLETO) ---
            ...
            # --- BLOCO 4: GRÁFICO TRADINGVIEW (COMPLETO) ---
            st.markdown("---")
