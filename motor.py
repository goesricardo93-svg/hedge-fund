...
class MotorAnalise:
    ...
    def analisar(self, hist, info, ticker):
        try:
            ...
            # --- 4. DIVIDENDOS (MANUAL PARA EVITAR 1214%) ---
            dy_anual = 0.0
            try:
            ...
            if "COMPRA" in sinal_tecnico: score += 15; motivos.append("Sinal Técnico")
            ...
            if is_fii:
                ...
                if dy_anual > 8.0: score += 10; motivos.append("DY Atrativo")
            else:
                ...
                if divida_ebitda > 3.5: score -= 10; alertas.append("Dívida Alta")
            ...
            return None # Retorna None silenciosamente se falhar, evitando crash
